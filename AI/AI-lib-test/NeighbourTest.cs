...
namespace AI_lib_test
{
    ...
    {
        public class AvailableNeighbours : NeighbourTest
        {
            [Fact]
        ...
        public class NeighbourMatrix : NeighbourTest
        {
            [Fact]
        ...
        public class NeighbourDirections : NeighbourTest
        {
            [Theory]
            [InlineData("A1")]
            [InlineData("A7")]
        ...
        public class NeighbourMinMaxFromCoords : NeighbourTest
        {
            [Theory]
